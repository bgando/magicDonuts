	...
	$stateProvider
		...
		.state("pythonChatroom", {
			...
			views: {
				...
				// html and controller required for onlineUsers view
				"onlineUsers@pythonChatroom": { templateUrl: "app/resources.html"},
		// 		//html and controller required for chatrooms view
		...
		.state("Html5Chatroom", {
			...
			views: {
				...
				// html and controller required for onlineUsers view
				"onlineUsers@Html5Chatroom": { templateUrl: "app/resources.html"},
		// 		//html and controller required for chatrooms view
		...
		.state("CssChatroom", {
			...
			views: {
				...
				// html and controller required for onlineUsers view
				"onlineUsers@CssChatroom": { templateUrl: "app/resources.html"},
		// 		//html and controller required for chatrooms view
